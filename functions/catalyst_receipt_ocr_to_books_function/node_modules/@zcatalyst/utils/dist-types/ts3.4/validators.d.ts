 ...
 * ```
 */
export declare function isURL(urlStr: unknown, allowedProtocols?: Array<string>): boolean;
 ...
 * ```
 */
export declare function isValidUrl(urlStr: unknown, allowedProtocols?: Array<string>): boolean;
/**

...
exports.LOGGER = exports.Logger = exports.LEVEL = void 0;
...
function createLogger(level = LEVEL.NONE) {
...
function getLogLevelFromEnv() {
    if (typeof process !== 'undefined' && process && process.env && process.env.ZC_LOG_LVL) {
        ...
        return LEVEL[lvl] || LEVEL.NONE;
    }
    if (typeof window !== 'undefined' && window.ZC_LOG_LVL) {
        const lvl = window.ZC_LOG_LVL.toUpperCase();
        return LEVEL[lvl] || LEVEL.NONE;
    }
    return LEVEL.NONE;
}

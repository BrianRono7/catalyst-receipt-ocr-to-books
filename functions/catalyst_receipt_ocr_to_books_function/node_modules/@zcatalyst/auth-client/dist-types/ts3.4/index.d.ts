 ...
 * ```
 */
export declare function getCredentials(): Promise<void>;
/**
 ...
 * ```
 */
export declare function setDefaultProjectConfig(): void;
/**
 ...
 * ```
 */
export declare function addDefaultAppHeaders(headers?: Record<string, string>): Record<string, string>;
/**
 ...
 * ```
 */
export declare function collectZCRFToken(): Promise<unknown>;
export { Auth_Protocol, ConfigStore };
export * from './utils/constants';
export { clearStratusJwt, getStratusJwtExpiry, getStratusSessionVersion, isStratusJwtFresh, setStratusJwtExpiry, STRATUS_JWT_COOKIE, STRATUS_JWT_EXPIRY_KEY, STRATUS_JWT_EXPIRY_SKEW_MS, STRATUS_SESSION_VERSION_KEY, syncProjectSession } from './utils/session';
